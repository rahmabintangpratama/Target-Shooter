...
class HardBActivity : AppCompatActivity() {
    private lateinit var binding: ActivityHardBBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityHardBBinding.inflate(layoutInflater)
    ...
    private fun endGame() {
        ...
        binding.btnNextStage.setOnClickListener {
            ...
            val intent = Intent(this, HardCActivity::class.java)
